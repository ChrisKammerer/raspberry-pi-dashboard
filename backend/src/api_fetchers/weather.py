...
from backend.src.db_utils import init_db, upsert_cache, get_cache
...
def get_current_weather():
    params = {"key": api_key, "q": f"{WEATHER_LAT},{WEATHER_LON}"}
...
def get_forecast_weather(days):
    params = {"key": api_key, "q": f"{WEATHER_LAT},{WEATHER_LON}", "days": days}
